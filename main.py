...
# 🎀 상단 제목
st.markdown("""
<h1 style='text-align: center; font-size: 3em;'>💼 MBTI 진로 추천</h1>
<p style='text-align: center; font-size: 1.2em; color: #555;'>당신의 MBTI 유형에 어울리는 직업을 추천해드릴게요 :)</p>
<hr>
...
selected_mbti = st.selectbox("", list(mbti_jobs.keys()))
...
if selected_mbti:
    ...
    st.success("✨ 위의 직업들은 당신의 성향과 잘 어울릴 수 있어요!")

# 푸터
st.markdown("---")
st.markdown("""
<div style='text-align: center; color: #aaa; font-size: 0.9em;'>
    Made with ❤️ by ChatGPT · Powered by Streamlit
</div>
""", unsafe_allow_html=True)
import streamlit as st
import random
